        ...
        body: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Color(0xFF000000),
                Color.fromARGB(255, 29, 11, 56),
                Color.fromARGB(255, 94, 32, 175)
              ],
            ),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Abhijith AJ built the MUZO app as a Free app. This SERVICE is provided by Abhijith AJ at no cost and is intended for use as is.",
                    style: termstyle(),
                  ),
                  heightedbox(),
                  Text(
                  ...
                  heightedbox(),
                  Text(
                    "The terms used in this Privacy policy have the same meaning as in our Terms and Conditions,Which are accessible at MUZO unless otherwise defined in this Privacy Policy.",
                    style: termstyle(),
                  ),
                  heightedbox(),
                  const Text(
